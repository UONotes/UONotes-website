...
export function AuthCard({ children }: { children: ReactNode }) {
  return (
    <motion.div
      ...
      // Replaced shadow-2xl with a clean downward-facing shadow to eliminate the top grey haze artifact
      className="w-full max-w-lg bg-white p-8 sm:p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-brand-red/15 relative overflow-hidden"
    >
