    ...
    <section className="relative w-full min-h-[calc(100vh-80px)] flex flex-col items-center justify-center overflow-hidden py-10 sm:py-16 lg:py-24">
      ...
      >
        ...
        <motion.div variants={fadeUpAnim} className="flex items-center gap-1.5 sm:gap-2 mb-8 sm:mb-10">
          ...
          <a href="https://www.tiktok.com/@uo_notes" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-gray-200 text-gray-700 text-[10px] sm:text-xs font-semibold shadow-xs hover:border-brand-red/40 hover:text-brand-red transition-all">            <svg className="w-3.5 h-3.5 fill-current text-brand-red" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
            <span>TikTok</span>
          </a>
        </motion.div>
